...
class Admin_Notice {
	...
	public function powered_by_notice() {
		...
		<div class="mt-8 border-t border-slate-300 pt-4 text-center text-gray-500 text-sm select-none flex items-center justify-center gap-2">
			...
			<span>
				<?php esc_html_e( 'Powered by', 'entrydashboard' ); ?> <a href="https://entriesmanager.com?utm_source=wpdashboard" target="_blank" rel="noopener noreferrer" class="font-semibold text-indigo-600 hover:text-indigo-700 transition"><?php echo esc_html( 'Entries Manager' ); ?></a>
			</span>
		</div>
		<?php
	}
